...
$expectedContractVersion = "2.1.27"
...
if (-not (Test-Path -LiteralPath $packageCssPath)) {
    ...
    if ($packageCssHash -cne $expectedPackageCssSha256) {
        Add-Violation "Restored OPX package stylesheet hash must be $expectedPackageCssSha256 for package 2.1.27; found $packageCssHash."
    }
}
