...
$expectedContractVersion = "2.1.26"
$expectedPackages = [ordered]@{
    "Opx.MudBlazor.FlatUi" = "2.1.26"
    "MudBlazor" = "9.9.0"
}
$expectedHostCssSha256 = "3BCB8DDE3956E3ACEF5CD91C779882222871DB6BA53F48D9237CC70F2E5C18F7"
$expectedPackageCssSha256 = "195B0111B3F1F8592034C1B123DC8B977607FA293F49A02D1A034EAFAC483FA3"
...
if (-not (Test-Path -LiteralPath $packageCssPath)) {
    ...
    if ($packageCssHash -cne $expectedPackageCssSha256) {
        Add-Violation "Restored OPX package stylesheet hash must be $expectedPackageCssSha256 for package 2.1.26; found $packageCssHash."
    }
}
