...
- The accepted public baseline is NuGet `Opx.MudBlazor.FlatUi` 2.1.26. Import additive package contracts into rules, skills, templates, and audits while preserving this repository's NuGet-only consumer boundary.
