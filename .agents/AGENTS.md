...
5. Open the closest matching page under `samples/Opx.MudBlazor.FlatUi.Sample` from the skill's sample source map.
6. Open every reusable component under `src/Opx.MudBlazor.FlatUi` used by that sample before changing its API or behavior.
