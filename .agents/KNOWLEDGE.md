...
- Reusable UI dependency: public NuGet `Opx.MudBlazor.FlatUi` `2.1.2`; package source checkout is inspection authority only, never a consumer `ProjectReference`.
...
## Imported 2.1.2 package capabilities
