...
Require-Tokens "Opx.MudBlazor.FlatUi.MauiHost.Sample.csproj" @(
    'PackageReference Include="Opx.MudBlazor.FlatUi" Version="2.1.3"',
...
Write-Output "MAUI shared-page audit passed: $($showcaseRoutes.Count) Showcase routes load once; $($hostRoutes.Count) MAUI-only routes remain in the host; OPX UI uses NuGet 2.1.3."
