...
Require-Tokens "Opx.MudBlazor.FlatUi.MauiHost.Sample.csproj" @(
    'PackageReference Include="Opx.MudBlazor.FlatUi" Version="2.1.27"',
...
Require-Tokens "wwwroot\index.html" @(
    ...
    'data-opx-use-app-font-size="false"',
    'data-opx-font-size="16"',
    'data-opx-minimum-font-size="12"',
    'data-opx-maximum-font-size="18"',
    'data-opx-density="Default"',
...
Write-Output "MAUI shared-page audit passed: $($showcaseRoutes.Count) Showcase routes load once; $($hostRoutes.Count) MAUI-only routes remain in the host; OPX UI uses NuGet 2.1.27."
