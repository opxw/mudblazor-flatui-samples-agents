...
This consumer repository restores reusable UI from public NuGet `2.1.34`; the local `Showcase` project contains composition only. To prove package consumption, build with:
